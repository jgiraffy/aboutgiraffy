export const en = {
  ...
  prMedia: {
    ...
    press: {
      ...
      releases: [
        { title: "Giraffy launches to bring full market transparency to household finance", date: "2026", content: "Placeholder press release content. Replace with your actual press release text." },
        { title: "How Giraffy Radar is changing the way consumers compare financial products", date: "2026", content: "Placeholder press release content. Replace with your actual press release text." },
        { title: "Giraffy expands into nine markets across the Middle East and Europe", date: "2026", content: "Placeholder press release content. Replace with your actual press release text." },
      ],
    },
    contact: {
